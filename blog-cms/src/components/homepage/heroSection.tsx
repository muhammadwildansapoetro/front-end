    ...
    <section className="pt-36 lg:pt-60 pb-96">
      <div className="container mx-auto">
        <div className="mx-5 lg:mx-36 lg:text-center">
          <h1 className="font-semibold text-xl text-slate-600 lg:text-2xl hidden lg:block">
            Hi, I am Muhammad Wildan Sapoetro and welcome to my blog.
          </h1>
          <h1 className="font-semibold text-xl text-slate-600 lg:text-2xl lg:hidden block">
