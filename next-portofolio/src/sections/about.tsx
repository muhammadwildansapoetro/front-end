    ...
    >
      <div className="flex w-full flex-col md:w-[1000px]">
        ...
        <p className="mt-5 text-lg text-gray-700 md:mt-10 md:text-justify md:text-xl">
          ...
          technologies like JavaScript, TypeScript, React.js, Next.js, Node.js,
        ...
        <p className="mt-5 text-lg text-gray-700 md:text-justify md:text-xl">
          ...
          and research project, where I developed skills in team collaboration,
          operations management, and process optimization. These experiences
          have shaped my approach to development, emphasizing efficiency, clear
          communication, and problem-solving.
        </p>

        <p className="mt-5 text-lg text-gray-700 md:text-justify md:text-xl">
          I studied Agricultural Engineering at Universitas Padjadjaran, where I
          also gained leadership experience as a Lecture Assisstant, Project
        ...
        <p className="mt-5 text-lg text-gray-700 md:text-justify md:text-xl">
          ...
          grow as a web developer, and contribute to a team, be part of projects
          that make a positive impact. I&apos;m eager to discuss new
